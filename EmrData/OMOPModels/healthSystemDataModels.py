...
class LOCATION_HISTORY(models.Model):
    ...
    relationship_type_concept = models.ForeignKey(CONCEPT, on_delete=models.DO_NOTHING, limit_choices_to=Q(
...
class CARE_SITE(models.Model):
    ...
    place_of_service_concept = models.ForeignKey(CONCEPT, on_delete=models.DO_NOTHING, limit_choices_to=Q(
...
class PROVIDER(models.Model):
    ...
    specialty_concept = models.ForeignKey(CONCEPT, on_delete=models.DO_NOTHING, limit_choices_to=Q(
        domain__domain_id="Provider") & Q(standard_concept='S'), related_name="+")
    care_site = models.ForeignKey(CARE_SITE, on_delete=models.DO_NOTHING, null=True, related_name='provider')
    year_of_birth = models.IntegerField(null=True)
    gender_concept = models.ForeignKey(CONCEPT, on_delete=models.DO_NOTHING, limit_choices_to=Q(
    ...
    specialty_source_concept = models.ForeignKey(CONCEPT, on_delete=models.DO_NOTHING, related_name="+")
    gender_source_value = models.CharField(max_length=50, null=True)
    gender_source_concept = models.ForeignKey(CONCEPT, on_delete=models.DO_NOTHING, related_name="+")

...
class PERSON(models.Model):
    ...
    gender_concept_id = models.ForeignKey(CONCEPT, on_delete=models.DO_NOTHING,
                                          limit_choices_to=Q(domain_id='Gender') & Q(standard_concept='S'), related_name="+")
    ...
    race_concept_id = models.ForeignKey(CONCEPT, on_delete=models.DO_NOTHING,
                                        limit_choices_to=Q(domain_id='Race') & Q(standard_concept='S'), null=True, related_name="+")
    ethnicity_concept_id = models.ForeignKey(CONCEPT, on_delete=models.DO_NOTHING,
                                             limit_choices_to=Q(domain_id='Ethnicity') & Q(standard_concept='S'), null=True, related_name="+")
    # location_id TODO
    # provider_id TODO
    # care_site_id TODO

...
class PAYER_PLAN_PERIOD(models.Model):
    ...
    sponsor_concept_id = models.ForeignKey(CONCEPT, on_delete=models.DO_NOTHING, limit_choices_to=Q(
        domain__domain_id="Sponsor") & Q(standard_concept='S'), related_query_name="+", null=True)
...
class COST(models.Model):
    ...
    revenue_code_concept_id = models.ForeignKey(CONCEPT, on_delete=models.DO_NOTHING, related_name="+", null=True)
    revenue_code_source_value = models.CharField(max_length=50, null=True)
    drg_concept_id = models.ForeignKey(CONCEPT, on_delete=models.DO_NOTHING, related_name="+", null=True)

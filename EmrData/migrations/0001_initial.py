    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vocabulary_concept_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='vocabulary_id', to='EmrData.CONCEPT')),
            ],
            options={
                'db_table': 'VOCABULARY',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ethnicity_concept_id', models.ForeignKey(limit_choices_to=models.Q(('domain_id', 'Ethnicity'), ('standard_concept', 'S')), null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='EmrData.CONCEPT')),
                ...
                ('gender_concept_id', models.ForeignKey(limit_choices_to=models.Q(('domain_id', 'Gender'), ('standard_concept', 'S')), on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='EmrData.CONCEPT')),
                ...
                ('race_concept_id', models.ForeignKey(limit_choices_to=models.Q(('domain_id', 'Race'), ('standard_concept', 'S')), null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='EmrData.CONCEPT')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('domain_concept_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='domain_id', to='EmrData.CONCEPT')),
            ],
            options={
                'db_table': 'DOMAIN',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('concept_class_concept_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='concept_class_id', to='EmrData.CONCEPT')),
            ],
            options={
